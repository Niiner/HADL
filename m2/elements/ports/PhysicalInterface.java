...
public abstract class PhysicalInterface extends Observable {
	...
	/**
	 * Constructor 
	 * @param name The name of the {@link PhysicalInterface}
	 * @param interfaceT The {@link InterfaceType} of the {@link PhysicalInterface}
	 * @param visibilityT The {@link VisibilityType} of the {@link PhysicalInterface}
	 */
